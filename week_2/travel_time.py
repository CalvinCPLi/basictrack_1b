...
distance = float(input("What is the distance to your destination (in km)?"))
...
if option == "Walking":
    ...
    print(travel_time_biking, "hour(s)", travel_time_biking_minutes, "minute(s)")
elif option == "Driving":
    ...
    speed_walking = float(input("What is your speed while walking? (in km/h)"))
    speed_walking_ms = speed_walking / 3.6 #convert to m/s
    travel_time_parking = (parking_spot_distance / speed_walking_ms) #seconds
    travel_time_parking_seconds = travel_time_parking/ 60 #minutes
    print(travel_time_driving, "hours or", travel_time_driving_minutes, "minute(s) to your destination and",
          travel_time_parking, "second(s) or", travel_time_parking_seconds, "minute(s) to the door!")
